...
class UsersSpecificPostScreen extends StatefulWidget {


  String? userId;
  String? userName;

  UsersSpecificPostScreen({
   this.userId,
    this.userName,
});
  @override
  State<UsersSpecificPostScreen> createState() => _UsersSpecificPostScreenState();
}




class _UsersSpecificPostScreenState extends State<UsersSpecificPostScreen>{
